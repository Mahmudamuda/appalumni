...
<head>
    ...
    <title>BALAI LATIHAN MASYARAKAT BANJARMASIN</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo base_url() ?>index.php/welcome" class="logo">
                ...
                <span class="logo-mini"><b>B</b>LM</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>BLM</b> Banjarmasin</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2024 <a href="https://www.instagram.com/mahmudaaa_">Mahmuda</a>.</strong> All rights
            reserved.
        </footer>
